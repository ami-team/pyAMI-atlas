...
def entry_point():
    ...
    sub_parser.set_defaults(func = api.mode_show_ami_tag)
    ...
    #    sub_parser.set_defaults(func = api.mode_show_hierarchical_ami_tag)
    ...
    sub_parser.set_defaults(func = api.mode_show_dataset_info)
    ...
    sub_parser.set_defaults(func = api.mode_show_dataset_hashtags)
    ...
    sub_parser.set_defaults(func = api.mode_show_dataset_prov)
    ...
    sub_parser.set_defaults(func = api.mode_show_file)
    ...
    sub_parser.set_defaults(func = api.mode_show_paper)
    ...
    sub_parser.set_defaults(func = api.mode_list_commands)
    ...
    sub_parser.set_defaults(func = api.mode_list_projects)
    ...
    sub_parser.set_defaults(func = api.mode_list_subprojects)
    ...
    sub_parser.set_defaults(func = api.mode_list_types)
    ...
    sub_parser.set_defaults(func = api.mode_list_subtypes)
    ...
    sub_parser.set_defaults(func = api.mode_list_prodsteps)
    ...
    sub_parser.set_defaults(func = api.mode_list_nomenclature)
    ...
    sub_parser.set_defaults(func = api.mode_list_datasets)
    ...
    sub_parser.set_defaults(func = api.mode_list_dataperiods)
    ...
    sub_parser.set_defaults(func = api.mode_list_runs)
    ...
    sub_parser.set_defaults(func = api.mode_list_files)
